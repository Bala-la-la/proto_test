...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "map_parking_space.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::Descriptor* ParkingSpace::descriptor() {
  ::protobuf_map_5fparking_5fspace_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_map_5fparking_5fspace_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ParkingSpace& ParkingSpace::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_map_5fparking_5fspace_2eproto::scc_info_ParkingSpace.base);
...
::google::protobuf::Metadata ParkingSpace::GetMetadata() const {
  protobuf_map_5fparking_5fspace_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_map_5fparking_5fspace_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
ParkingLot::ParkingLot()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_map_5fparking_5fspace_2eproto::scc_info_ParkingLot.base);
  SharedCtor();
...
const ParkingLot& ParkingLot::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_map_5fparking_5fspace_2eproto::scc_info_ParkingLot.base);
  return *internal_default_instance();
}
